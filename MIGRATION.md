...
|---|---|---|
| P §1 (question, belief definition, why this substrate) | `program/orientation.md` + `components/c-terminology.md` | ☑ |
| P §1 (three motivating problems) | `program/orientation.md` | ☑ |
| P §2 (scope, three structural facts) | `catalogue/phases.md` + `components/c-substrate.md` | ☑ |
| P §3.1 (game) | `components/c-substrate.md` | ☑ |
| P §3.2 (opponent ladder) | `components/c-substrate.md` | ☑ |
| P §3.3 (action channels) | `components/c-substrate.md` + three `r-phase-c-*` runs | ☑ |
| P §3.4 (episode) | `components/c-substrate.md` | ☑ |
| P §4 (pool, splits, diversity) | `components/c-substrate.md` + `r-diversity-sweep` | ☑ |
| P §5 (tokenization) | `components/c-substrate.md` | ☑ |
| P §6 (solver) | `components/c-solvers.md` + `r-solver-verification` | ☑ |
| P §7 (model) | `components/c-training.md` | ☑ |
| P §8 (phase ladder, seeds, checkpointing) | `components/c-training.md` + the run nodes | ☑ |
| P §9.1 (transition) | `s-transition-boundary` | ☑ |
| P §9.2 (decodability) | `components/c-inst-derived.md` + `s-decodability-timing` | ☑ |
...
| P §9.5 (interventions) | `components/c-inst-grounded.md` + `s-causal-structure` | ☑ |
| P §10 (controls) | `components/c-inst-derived.md` + `components/c-inst-grounded.md` | ☑ |
...
| P §13 (terminology) | `components/c-terminology.md` | ☑ |
...
| Source | Destination | Done |
|---|---|---|
| R1, R3, R20–R21, R23, R25 (substrate) | `components/c-substrate.md` | ☑ |
| R2, R8, R24 (solver, scalars, ladder) | `components/c-solvers.md` | ☑ |
| R4, R5, R12b (training, seeds) | `components/c-training.md` | ☑ |
| R6, R7, R12, R14, R15, R31 (instruments) | `components/c-inst-derived.md` | ☑ |
| R11, R13, R14 (grounded side) | `components/c-inst-grounded.md` | ☑ |
| R9, R10 (vocabulary) | `components/c-terminology.md` | ☑ |
...
| O §7 (recorded positions) | `program/orientation.md` + `components/c-terminology.md` | ☑ |
| O §8 (open strategic questions) | `records/questions.md` | ☑ |
| Q1, Q2 | `records/questions.md` | ☑ |
| Q reiterate list | `components/c-terminology.md` | ☑ |
